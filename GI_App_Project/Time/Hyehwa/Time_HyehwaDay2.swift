            ...
            VStack {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    if let timeschuele = timeDataFetcher.timeData {
                        ...
                        HStack {
                            Text("\(timeschuele.results[11].properties.랩.richText[0].plainText) 수업" )
                                .font(.system(size: 20))
                                .fontWeight(.semibold)
                        ...
                        if let timeschuele = timeDataFetcher.timeData {
                            Text("\(timeschuele.results[11].properties.dayTime.title [0].plainText)")
                                .font(.system(size: 18))
                                .fontWeight(.regular)
                ...
                .frame(width: 289, height: 27)
                   ...
                   VStack(alignment: .leading, spacing: 10) {
                       ...
                       HStack {
                               ...
                               Text("\(timeschuele.results[9].properties.랩.richText[0].plainText)")
                                   .font(.system(size: 20))
                                   .fontWeight(.semibold)
                       ...
                       if let timeschuele = timeDataFetcher.timeData {
                           Text("\(timeschuele.results[9].properties.dayTime.title [0].plainText)")
                               .fontWeight(.regular)
                               .foregroundColor(Color.white)
